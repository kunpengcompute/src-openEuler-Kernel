...
- !16704  ima: prevent concurrent list operations in ima_lsm_update_rules
- video: fbdev: amba-clcd: Fix refcount leak bugs
- !16554 [openEuler-1.0-LTS] PCI: Supplement ACS quirk for more Zhaoxin Root Ports
...
- !11759  sch/netem: fix use after free in netem_dequeue
- arm64: cpufeature: Fix the visibility of compat hwcaps
- arm64: cpufeature: Force HWCAP to be based on the sysreg visible to user-space
- irqchip/armada-370-xp: Do not allow mapping IRQ 0 and 1
- irqchip/gic-v3-its: Remove BUG_ON in its_vpe_irq_domain_alloc
- irqchip/mbigen: Fix mbigen node address layout
- !11737  hwmon: (adc128d818) Fix underflows seen when writing limit attributes
- !11692  fix CVE-2024-46723
- !11695  wifi: mwifiex: Do not return unused priv in mwifiex_get_priv_by_id()
...
* Wed May 29 2024 chenyi <chenyi211@huawei.com> - 4.19.90-2405.5.0.0278
...
* Wed Apr 17 2024 chenyi <chenyi211@huawei.com> - 4.19.90-2404.2.0.0273
...
- virtio_net: Fix Fix "‘%d’ directive writing between 1 and 11 bytes into a region of size 10" warnings
...
* Wed Mar 06 2024 hongrongxuan <hongrongxuan@huawei.com> - 4.19.90-2403.1.0.0268
...
* Tue Feb 27 2024 hongrongxuan <hongrongxuan@huawei.com> - 4.19.90-2402.6.0.0267
